...
class ProfileViewModel {
    ...
    init(userProfile: UserProfile) {
        ...
        self.posts = [
            ...
            Post(author: "Geralt of Rivia", description: "The White Wolf, a renowned Witcher known for his skill with the sword and his ability to slay monsters.", image: "post3", likes: 151, views: 201),
